...
export function getCurrency(code) {
  return CURRENCIES.find(c => c.code === code) || CURRENCIES.find(c => c.code === 'PHP')
}

// Format amount with currency symbol — all amounts stored in PHP
// rate = how much 1 PHP is worth in target currency
export function fmt(amount, currencyCode = 'PHP', rate = 1) {
  ...
  return `${currency.symbol}${converted.toLocaleString('en-PH', { minimumFractionDigits: 2 })}`
}